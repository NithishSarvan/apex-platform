    ...
    return (
        <div className="main-content">
            ...
            <div className="flex justify-between items-start mb-8">
                <div>
                    <h1 className="text-2xl font-bold text-gray-900 mb-2">Utilization Report</h1>
                ...
                <div className="bg-white rounded-lg border border-gray-200 p-5">
                    ...
                    <div className="h-64 flex items-center justify-center border border-dashed border-gray-300 rounded-lg">
                        <div className="text-center">
                            <FiBarChart2 className="mx-auto text-3xl text-gray-400 mb-2" />
                    ...
                    <table className="w-full">
                        <thead className="bg-gray-50">
                            <tr>
                                ...
                                <th className="py-3 px-4 text-left text-xs font-medium text-gray-500">Period</th>
                                <th className="py-3 px-4 text-left text-xs font-medium text-gray-500">Utilization</th>
                                <th className="py-3 px-4 text-left text-xs font-medium text-gray-500">API Calls</th>
                                <th className="py-3 px-4 text-left text-xs font-medium text-gray-500">Storage</th>
                                <th className="py-3 px-4 text-left text-xs font-medium text-gray-500">Compute</th>
