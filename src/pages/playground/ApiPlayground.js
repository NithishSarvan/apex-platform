...
export const ApiPlaygroundPage = () => {
  ...
  const dataTypes = [
    {
      value: "string",
      label: "String",
      icon: <LuTextCursor className="text-blue-500" />,
    },
    {
      value: "number",
      label: "Number",
      icon: <FiHash className="text-green-500" />,
    },
    {
      value: "boolean",
      label: "Boolean",
    ...
    },
    {
      value: "binary",
      label: "Binary",
      icon: <TbBinary className="text-orange-500" />,
    },
    {
      value: "array",
      label: "Array",
    ...
    },
    {
      value: "object",
      label: "Object",
      icon: <FiGrid className="text-teal-500" />,
    },
  ];
  ...
  const generateRequestPayload = () => {
    const buildObject = (fields, data) => {
      ...
      fields.forEach((field) => {
        const value =
          data[field.name] || data[`${field.parentId}.${field.name}`];
  ...
  const renderFieldEditor = (
    ...
    return (
      <div key={field.id} className={`mb-3 ${depth > 0 ? "ml-6" : ""}`}>
        <div
          className={`flex items-center gap-3 p-3 border rounded-lg ${isEditing ? "border-[#02b499] bg-[#02b499]/5" : "border-gray-200 hover:border-gray-300"}`}
        >
          ...
          {isEditing ? (
            <div className="flex-1 space-y-3">
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <div>
                  <label className="mb-1 text-xs text-gray-600">Required</label>
                  <div className="mt-1">
                    <input
                      type="checkbox"
              ...
              <div className="flex justify-between">
                ...
                <button
                  onClick={() =>
                    handleDeleteField(field.id, isRequest, parentId)
                  }
        ...
        <div key={field.id} className="mb-4">
          ...
          {field.type === "string" && (
            <input
              ...
              value={value}
              onChange={(e) =>
                setRequestData({ ...requestData, [fieldKey]: e.target.value })
              }
    ...
    <div className="main-content">
      ...
      >
        ...
        <div className="flex items-center justify-between mb-3">
          ...
          <div className="flex items-center gap-2">
            <button className="save-conf-btn align-right">Save</button>
          </div>
        </div>

        <div className="my-4 heighligts">
          <p className="text-sm text-gray-600">
            Design custom API endpoints with dynamic request/response structures
          </p>
        </div>

        <div className="flex flex-col mb-6 border-b border-gray-200 md:flex-row">
          {tabs.map((tab) => (
            <button
              key={tab.id}
          ...
          <div>
            <div className="p-4 mb-4 bg-white border border-gray-200 rounded-lg">
              <div className="flex items-center justify-between ">
                ...
                <div className="flex items-center gap-0 p-1 bg-gray-100 rounded-lg">
                  <button
              ...
              <div className="p-4 mb-4 bg-white border border-gray-200 rounded-lg">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-gray-600">
                      Design request and response structures for your endpoints
                    </p>
                  </div>
                      ...
                      <div>
                        ...
                        <div className="flex items-center gap-3 mt-1 text-sm text-gray-600">
                          <code className="px-2 py-1 bg-white border rounded">
                            {selectedEndpoint.method} {selectedEndpoint.baseUrl}
              ...
              <div className="p-6 bg-white border border-gray-200 rounded-lg">
                <div className="flex items-center justify-between mb-6">
                  ...
                  <button
                    ...
                    className="flex items-center gap-2 text-sm check-btn"
                  >
                    <FiPlus /> Add Field
                  </button>
                </div>
                ...
                <div className="space-y-4">
                  {requestStructure.map((field) =>
                    renderFieldEditor(field, true),
                  )}

                  {requestStructure.length === 0 && (
                    <div className="py-12 text-center text-gray-500">
                      <FiPlus className="mx-auto mb-3 text-3xl opacity-50" />
                ...
                <div className="pt-6 mt-8 border-t border-gray-200">
                  ...
                  <pre className="p-4 overflow-auto text-sm border border-gray-200 rounded-lg bg-gray-50 max-h-60">
          ...
          <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
            ...
            <div className="p-6 bg-white border border-gray-200 rounded-lg">
              <div className="flex items-center justify-between mb-6">
                ...
                <button
                  ...
                  disabled={loading}
                  className="flex items-center gap-2 check-btn"
                >
                  {loading ? (
                    <>
              ...
              <div className="pt-6 mt-8 border-t border-gray-200">
                <h4 className="mb-3 font-medium">Request Payload Preview</h4>
                <pre className="p-4 overflow-auto text-sm border border-gray-200 rounded-lg bg-gray-50 max-h-60">
                  {JSON.stringify(generateRequestPayload(), null, 2)}
                </pre>
              </div>
            ...
            <div className="p-6 bg-white border border-gray-200 rounded-lg">
              ...
              {error ? (
                ...
                <>
                  <div className="mb-6">
                    <h4 className="mb-3 font-medium">Response Data</h4>
                    <pre className="p-4 overflow-auto text-sm border border-gray-200 rounded-lg bg-gray-50 max-h-96">
                      {JSON.stringify(responseData, null, 2)}
                    </pre>
                  </div>
                    ...
                    <div className="space-y-2">
                      {responseStructure.map((field) => (
                        ...
                        >
                          ...
                          <span
                            className={`text-sm ${responseData[field.name] !== undefined ? "text-green-600" : "text-red-600"}`}
                          >
                            {responseData[field.name] !== undefined
                              ? "✓ Present"
                              : "✗ Missing"}
                          </span>
                        </div>
                ...
                <div className="py-12 text-center text-gray-500">
                  <FiPlay className="mx-auto mb-3 text-3xl opacity-50" />
          ...
          <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
            ...
            <div className="p-6 bg-white border border-gray-200 rounded-lg">
              ...
              <pre className="bg-gray-900 text-gray-100 rounded-lg p-4 text-sm overflow-auto max-h-[600px]">
                {JSON.stringify(
                  generateJsonSchema(requestStructure, false),
                  null,
                  2,
                )}
              </pre>
            ...
            <div className="p-6 bg-white border border-gray-200 rounded-lg">
              ...
              <pre className="bg-gray-900 text-gray-100 rounded-lg p-4 text-sm overflow-auto max-h-[600px]">
                {JSON.stringify(
                  generateJsonSchema(responseStructure, true),
                  null,
                  2,
                )}
              </pre>
        ...
        {activeTab === "endpoints" && (
          <div className="p-6 bg-white border border-gray-200 rounded-lg">
            <div className="flex items-center justify-between mb-6">
              <h3 className="text-lg font-semibold">Saved Endpoints</h3>
              <button
            ...
            <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
              {savedEndpoints.map((endpoint) => (
                <div
                  key={endpoint.id}
                  className="border border-gray-200 rounded-lg p-4 hover:border-[#02b499] transition-colors"
                >
                  <div className="flex items-start justify-between mb-3">
                    <div>
                      ...
                      <div className="flex items-center gap-2 mt-1">
                        <span
                          className={`px-2 py-1 text-xs rounded ${endpoint.method === "POST" ? "bg-green-100 text-green-800" : "bg-blue-100 text-blue-800"}`}
                        >
                          {endpoint.method}
                        </span>
                  ...
                  <div className="flex gap-2">
                    <button
                      ...
                      className="flex-1 py-1 text-sm check-btn"
                    >
                      Load
                    </button>
                    <button className="px-3 py-1 text-gray-700 border border-gray-300 rounded hover:bg-gray-50">
                      <FiEdit />
                    </button>
                  </div>
                </div>
            ...
            {/* Export Options */}
            {/* <div className="pt-6 mt-8 border-t border-gray-200">
                            <h4 className="mb-4 font-medium">Export Configuration</h4>
        ...
        {showNewEndpointModal && (
          <div
            className="fixed inset-x-0 top-[64px] bottom-0 bg-black bg-opacity-50 
            ...
            <div className="bg-white rounded-lg p-6 w-full max-w-2xl max-h-[90vh] overflow-y-auto">
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <div className="mt-4">
                    <label className="block mb-2 label">Description</label>
                    <textarea
                ...
                {/* API Configuration */}
                <div>
                  <h4 className="mb-4 font-medium">API Configuration</h4>
                  <div className="grid grid-cols-3 gap-4">
                    <div>
                      <label className="block mb-2 label">Base URL</label>
                      <input
                        type="text"
                    ...
                    <div>
                      <label className="block mb-2 label">Method</label>
                      <select
                ...
                {/* Structure Preview */}
                <div>
                  <h4 className="mb-4 font-medium">Structure Preview</h4>
                  <div className="p-4 border border-gray-200 rounded-lg bg-gray-50">
                    ...
                    <div className="text-sm text-gray-600">
                      This endpoint will include the current request and
                      response structures. You can modify them after creation.
                    </div>
                  </div>
                </div>
                ...
                <div className="flex justify-end gap-3 pt-4 border-t">
                  ...
                  <button
                    ...
                    className="flex items-center gap-2 px-4 py-2 check-btn"
                  >
